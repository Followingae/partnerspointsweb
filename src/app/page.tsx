...
import { Bar, BarChart, ResponsiveContainer, XAxis, YAxis, PieChart, Pie, Cell, RadialBarChart, RadialBar } from "recharts"
...
export default function Home() {
  ...
  if (mode === "customers") {
    return (
      <div className="min-h-screen">
            ...
            <div className="grid md:grid-cols-3 gap-8 max-w-4xl mx-auto">
              <InView className="animate-slide-up">
                <Card className="text-center">
                  <div className="w-12 h-12 rounded-full bg-accent text-white flex items-center justify-center mx-auto mb-6 text-lg font-bold">
                    1
                  </div>
                  <h3 className="h3 mb-3">Shop</h3>
                  <p className="text-inkMuted">Visit a partner merchant</p>
                </Card>
              </InView>
              <InView className="animate-slide-up">
                <Card className="text-center">
                  ...
                  <p className="text-inkMuted">Get points every time</p>
                </Card>
              </InView>
              <InView className="animate-slide-up">
                <Card className="text-center">
                  ...
                  <p className="text-inkMuted">Save on what you love</p>
                </Card>
              </InView>
            </div>
          </Container>
        ...
        {/* Benefits - Customer */}
        <Section className="bg-surfaceSecondary">
          <Container>
        ...
        <Section>
          <Container>
            <div className="text-center mb-16">
              ...
              <p className="text-inkMuted">More partners joining soon!</p>
            </div>
            <Card className="p-12 text-center">
              <div className="w-24 h-24 bg-surfaceSecondary rounded-full flex items-center justify-center mx-auto mb-6">
                <Store className="w-12 h-12 text-inkMuted" />
              </div>
              <p className="text-inkMuted">Featured merchants coming soon</p>
            </Card>
          </Container>
        </Section>
        ...
        <Section className="bg-surfaceSecondary">
          <Container>
            <div className="text-center max-w-2xl mx-auto">
              ...
              <p className="text-inkMuted mb-8">"Do points expire?" → It depends on the merchant.</p>
  ...
  return (
    <div className="min-h-screen">
      ...
      <section className="relative min-h-screen overflow-hidden">
        ...
        <Container className="relative">
          <div className="min-h-screen flex">
            ...
            <div className="w-1/2 flex items-center py-20 pr-8">
              <div className="space-y-8">
                <InView className="animate-hero">
                  <h1 className="h1">
                    Loyalty built into every transaction
                  </h1>
                </InView>
                <InView className="animate-slide-up">
                  <div className="space-y-6">
                    <p className="lead">
                      Stop losing money on blanket discounts. Pay only when customers actually redeem rewards — built into your existing POS terminal
                    </p>
                    <div className="inline-flex items-center gap-2 bg-surfaceSecondary/50 backdrop-blur-sm px-3 py-1.5 rounded-full border border-borderSoft">
                      <span className="text-xs text-inkMuted">Powered by</span>
                      <img 
                ...
                <InView className="animate-slide-up">
                  <div className="flex flex-col sm:flex-row gap-4">
                    <GlassButton variant="primary" className="px-6 py-3">
                      <Link href="/onboarding" className="flex items-center gap-2 no-underline text-white">
                        Get Started <ArrowRight className="h-5 w-5" />
                      </Link>
                    </GlassButton>
                    <GlassButton variant="light" className="px-4 py-2 text-sm">
                      <Link href="/calculator" className="no-underline text-black">
                        Try the Calculator
                      </Link>
                    </GlassButton>
                  </div>
            ...
            <div className="w-1/2 flex items-end">
              <InView className="animate-slide-left w-full">
                <img 
                  src="/hero-customers-new.png" 
                  alt="Partners Points customers earning rewards" 
        ...
        <Container>
          <div className="text-center mb-16 max-w-4xl mx-auto">
            <h2 className="h2 mb-6">
              <AnimatedText
                text="Discounts"
                className="line-through text-inkMuted mr-4 inline-block"
                variant="slide"
                stagger={0.1}
              />
              <AnimatedText
              ...
              <Card className="overflow-hidden">
                <div className="p-8">
                  <div className="text-center space-y-6">
                    <div className="bg-surfaceSecondary p-6 rounded-xl border border-borderSoft">
                      <div className="text-lg font-semibold text-accent mb-4">RFM Payment Terminal</div>
      ...
      <Section className="bg-surfaceSecondary">
        <Container>
          <div className="max-w-4xl mx-auto text-center">
            ...
            <GlassButton variant="primary" className="rounded-full">
              <Link href="/calculator" className="flex items-center gap-2 no-underline text-white">
      ...
      {/* Final CTA */}
      <Section className="bg-gradient-accent text-white relative overflow-hidden">
        <Container>
