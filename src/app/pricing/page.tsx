    ...
    <div className="min-h-screen bg-frosted-silver py-16">
      <div className="container mx-auto px-4 max-w-6xl">
        ...
        <div className="grid md:grid-cols-3 gap-8 mb-16">
          <BrandCard title="Simple Fee Structure" variant="elevated">
          ...
          <BrandCard title="Cost Control" variant="elevated">
            <ul className="space-y-3">
              <li className="flex items-start gap-3">
                <Check className="h-5 w-5 text-lime-burst flex-shrink-0 mt-0.5" />
          ...
          <BrandCard title="What's Included" variant="elevated">
            <ul className="space-y-3">
              <li className="flex items-start gap-3">
                <Check className="h-5 w-5 text-lime-burst flex-shrink-0 mt-0.5" />
        ...
        {/* FAQ Section */}
        <div className="mb-16">
          <BrandCard title="Pricing FAQ" variant="elevated">
