              ...
              <div key={index} className={`flex ${index % 2 === 0 ? 'lg:flex-row' : 'lg:flex-row-reverse'} gap-12 items-center`}>
                <ScrollReveal delay={index * 0.2} className="flex-1">
                  <Card  className="relative">
                    <div className="absolute -top-4 -left-4 w-12 h-12 bg-electric-blue text-white rounded-full flex items-center justify-center font-bold text-lg shadow-lg">
                      {index + 1}
                    </div>
                ...
                <ScrollReveal delay={index * 0.2 + 0.1} direction="right" className="flex-1">
                  <Card className="bg-gradient-to-br from-primary/5 via-secondary/5 to-accent/5 overflow-hidden">
