        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {contactMethods.map((method, index) => (
              <BrandCard key={index} variant="elevated" className="text-center hover:shadow-lg transition-all duration-300">
        ...
        <div className="container mx-auto px-4">
          <div className="grid lg:grid-cols-2 gap-16">
            ...
            <div>
              ...
              {isSubmitted ? (
                <BrandCard variant="elevated" className="text-center p-8">
            ...
            <div className="space-y-8">
              ...
              <div className="space-y-6">
                {offices.map((office, index) => (
                  <BrandCard key={index} variant="elevated">
              ...
              {/* Business Hours */}
              <BrandCard title="Business Hours" variant="gradient">
