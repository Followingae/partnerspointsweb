...
export function DocumentsStep({ data, onChange, errors }: DocumentsStepProps) {
        ...
        {file ? (
          ...
          <div>
            ...
            <Button
              ...
              className="w-full border-dashed border-electric-blue text-electric-blue hover:bg-electric-blue hover:text-white"
            >
  ...
  return (
    <BrandCard 
      ...
      description="Upload required documents and add your branding"
      variant="elevated"
      size="lg"
    >
